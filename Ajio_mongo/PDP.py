...
import config as db
from Productid_ajio import product_ids
...
html_save_path = rf'E:\\Nirav\\Project_page_save\\Ajio\\{db.TODAY}'
...
product_ids=list(collection.find(
  { "product_id": "701670824_pink" },#702130030_pink
  { "product_id": 1, "_id": 0 }
))
        ...
        if response.status_code == 200:
            ...
            if match:
                ...
                try:
                    ...
                    # formatted_offer = re.sub("\\s+", " ", formatted_offer)
                    ...
                    for m in product_mrp:
                        ...
                        # # if product_id_1.split("_")[0] in code:
