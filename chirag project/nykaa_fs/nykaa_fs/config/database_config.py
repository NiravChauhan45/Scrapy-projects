...
# db_password = 'actowiz'
# db_name = 'tesco'
# file_path = 'D:/Data/Abhishek_patel/Hertz_car_rental/Hertz_car_rental/Hertz_file/'
...
class ConfigDatabase():
    ...
    def fetchResultsfromSql(self,fields=[], conditions={}, group_by_cond = '',start=0, end=100000):
        ...
        # else:
        #     self.crsrSql.execute(f"select {fieldtofetch} from {self.table} {cond} and id between {start} and {end} group by {group_by}")
