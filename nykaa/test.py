...
collection_name = 'product_details_july_07'
# Connect to MongoDB
...
def fetch_and_parse_product(product_id):
    try:
        ...
        if product_data.get("id") == str(product_id):
            ...
            print("Best Offer:", best_offer_text)
            print("Best Price:", best_price)
            print("Bank Offers:", bank_offer_texts or "N/A")
...
res_data = fetch_and_parse_product(19528734)
print(res_data['specifications'])
...
#
# data = list(collection.find({"product_name": {"$ne": 'N/A'}}))
#
