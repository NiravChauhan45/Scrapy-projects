    ...
    def start_requests(self):
        ...
        for result in results:
            ...
            meta = {'id': id, 'new_category': new_category, 'name_of_the_brand': name_of_the_brand,
                    ...
                    'city_name': city_name, 'quantity_caping': quantity_caping,'big_basket_approve_not_approve':big_basket_approve_not_approve}

            # pagesave_path = fr"{db.pagesave_filepath}\{id}.html"
            yield scrapy.Request(
                url=f"file:///E:/Nirav/Project_page_save/big_basket_screenshot/03_08_2025/{id}.html", meta=meta,
...
if __name__ == '__main__':
    cmdline.execute(f"scrapy crawl {PdpDataSpider.name} -a start_index=1 -a end=100000".split())
