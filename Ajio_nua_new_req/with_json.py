...
# # collection_pdp = db[config.processed_collection_name]
...
# #
# #             try:
# #                 response = requests.get(product_url, headers=config.HEADERS, cookies=config.COOKIES, timeout=60,impersonate="Chrome110")
